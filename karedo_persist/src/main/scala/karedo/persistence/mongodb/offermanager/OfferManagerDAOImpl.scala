package karedo.persistence.mongodb.offermanager

import com.escalatesoft.subcut.inject.{BindingModule, Injectable}
import karedo.persistence.mongodb.{MongoUserAccount, MongoConnection}
import com.novus.salat.dao.SalatDAO
import java.util.UUID
import karedo.entity.dao.offermanager.RetailerDAO
