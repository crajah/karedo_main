...
case class AddAdvertCommand(brandId: UUID, text: String, imagePaths: List[String], value: Int)
case class AdvertDetail(text: String, imagePaths: List[String], value: Int)
case class AdvertDetailResponse(id: UUID, text: String, imagePaths: List[String], value: Int)
