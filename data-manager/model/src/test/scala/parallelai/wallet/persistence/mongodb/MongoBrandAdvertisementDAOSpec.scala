 ...
 */
class MongoBrandAdvertisementDAOSpec extends Specification with NoTimeConversions with MongoTestUtils {
  ...
  "BrandMongoDAO" should {
    ...
    val advDAO = new AdvertisementDetailMongoDAO
    ...
    "add two advertisings to brand and fetching them back" in {
      ...
      val ad = AdvertisementDetail(text = text1, imagePath = "imagepath", value = 100)
      ...
      val ad2 = AdvertisementDetail(text = text2, imagePath = "imagepath2", value = 200)
