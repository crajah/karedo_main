...
/**
  ...
  */
trait Kar12_postInform_actor extends DbCollections
  ...
  with JiraHandler
{
  ...
  override val logger = LoggerFactory.getLogger(classOf[Kar12_postInform_actor])

  def exec(request: Kar12Req): Result[Error, APIResponse] = {
