...
abstract class PersistentEntity {
  ...
  /**
    * INTERNAL API
    */
  case class PersistOne[B <: Event](event: B, afterPersist: B => Unit) extends Persist

  /**
    * INTERNAL API
    */
  case class PersistAll(events: immutable.Seq[Event], afterPersist: () => Unit) extends Persist

  /**
    * INTERNAL API
    */
  case object PersistNone extends Persist
